        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('update')}}" method="POST">
                    {{csrf_field()}}
                    <input type="hidden" value="{{$bill->id}}" class="form-control" name="id">
                    ...
                    <input type="number" value="{{$bill->cantidad}}" required class="form-control" name="cantidad">
                    <label>Valor Unitario</label>
                    <input type="number" required  value="{{$bill->valor_unitario}}" class="form-control" min="0" name="valor">
                    <label>Descuento %</label>
                    <input type="number" value="{{$bill->descuento}}" required class="form-control" min="0" name="descuento">
                    <br>
                    <center>
